...
FOR %%x IN ("\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\xampp-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\xampp-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\xampp-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\Users\vdiri\Desktop\behatPhp\xampp-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15-portable-windows-x64-7.3.6-4-VC15\php\php.exe"
